    ...
    location: {
      ...
      whatsAround: {
        ...
        editorial: {
          ...
          title: 'Prague',
          content: [
            "Located in Prague, Hotel Nerudova 211 is in the historical district. Notable landmarks in the area include Charles Bridge and Prague Astronomical Clock. Looking to enjoy an event or a game while in town? See what's happening at Generali Arena or Municipal House Hall. ",
          ],
        },
      },
      mapDialog: {
  ...
  propertyGallery: {
    ...
    images: [
      ...
      },
      {
        __typename: 'PropertyImage',
        accessibilityText:
          'Presidential Suite | Living area | 55-inch Smart TV with digital channels, TV, Netflix, image',
        actionLabel: 'Go to full screen',
        imageId: '762184787',
        image: {
          __typename: 'Image',
          ...
          description:
            'Presidential Suite | Living area | 55-inch Smart TV with digital channels, TV, Netflix',
        },
      },
      {
        __typename: 'PropertyImage',
      ...
      },
      {
        __typename: 'PropertyImage',
        accessibilityText:
          'Premier Suite | Living area | 55-inch Smart TV with digital channels, TV, Netflix, image',
        actionLabel: 'Go to full screen',
        imageId: '762183450',
        image: {
          __typename: 'Image',
          ...
          description:
            'Premier Suite | Living area | 55-inch Smart TV with digital channels, TV, Netflix',
        },
      },
      {
        __typename: 'PropertyImage',
